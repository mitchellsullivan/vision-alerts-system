...
import { AlertEventComponent } from 'app/entities/alert-event/alert-event.component';
...
describe('Component Tests', () => {
  describe('AlertEvent Management Component', () => {
    let comp: AlertEventComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AlertEventComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.alertEvents && comp.alertEvents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
