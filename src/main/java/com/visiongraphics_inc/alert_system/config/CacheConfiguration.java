...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.visiongraphics_inc.alert_system.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.visiongraphics_inc.alert_system.repository.UserRepository.USERS_BY_EMAIL_CACHE);
